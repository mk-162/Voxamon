    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-900 text-slate-100">
            <div className="bg-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-700 w-full max-w-md text-center">
                <h1 className="text-3xl font-black mb-2 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-500">
                    Voxacom<span className="text-oxide-red">.</span>
                </h1>
                <p className="text-slate-400 mb-8">Sign in to start recording</p>
